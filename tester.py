...
class TestRunner(object):
	...
	def BuildStudentDLL(self, search_directory):
		...
		if '0 Errores' not in str(output): assert False, 'Either it borked or you need to handle me better. Directory: ' + search_directory
...
# "/mnt/c/Program Files (x86)/Microsoft Visual Studio/2017/Community/Common7/IDE/MSTest.exe" "/testcontainer:QueueTests.dll" "/detail:errormessage" >| out.txt

if __name__ == '__main__':
	tester = TestRunner('','Assignment1.dll','QueueTests.dll')
	tester.RunTests('')